      ...
      <div className="hidden lg:flex lg:w-[45%] bg-gradient-to-br from-slate-900 via-blue-950 to-blue-900 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="text-blue-300 text-base leading-relaxed mb-10">
            Join event organizers who use EventIQ to optimize attendance, engagement, and event performance.
          </p>
          <div className="grid grid-cols-2 gap-4">
            {[
              { label: 'Setup time', value: '2 min' },
              { label: 'Events tracked', value: '∞' },
              { label: 'AI insights', value: 'Free' },
      ...
      <div className="flex-1 flex items-center justify-center bg-white px-8 py-12">
        <div className="w-full max-w-sm">
          <div className="mb-8">
            ...
            <p className="text-slate-500 mt-1 text-sm">Start managing events with AI-powered insights</p>
          </div>
